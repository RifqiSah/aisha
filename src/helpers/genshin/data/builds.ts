interface Role {
    [key: string]: {
        recommended: boolean;
        weapons: Array<{ id: string; refine?: number | number[]; stack?: number }>;
        artifacts: string[][];
        mainStats: {
            sands: string;
            goblet: string;
        ...
        roles: {
            SUPPORT: {
                ...
                artifacts: [
                    ['viridescent_venerer'],
                    ['noblesse_oblige'],
                    ['emblem_of_severed_fate', 'maiden_beloved'],
                ],
                mainStats: {
    ...
    noelle: {
        roles: {
            ...
            SUPPORT: {
                ...
                artifacts: [
                    ['husk_of_opulent_dreams'],
                    ['husk_of_opulent_dreams', 'maiden_beloved'],
                ],
                mainStats: {
                    sands: 'DEF%',
                    goblet: 'DEF%',
