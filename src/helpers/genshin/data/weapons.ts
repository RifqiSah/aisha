...
export const weapons: {
    [key: string]: {
        ...
        secondary: {
            name?: string;
            stats?: Array<null | number>;
        };
        atk: Array<null | number>;
    };
} = {
    dull_blade: {
        id: 'dull_blade',
    ...
    cool_steel: {
      ...
      'A reliable steel-forged weapon that serves as a testament to the great adventures of its old master.',
        skill: {
            ...
            description:
        'Increases DMG against opponents affected by Hydro or Cryo by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    harbinger_of_dawn: {
      ...
      'A sword that once shone like the sun. The wielder of this sword will be blessed with a "feel-good" buff. The reflective material on the blade has long worn off.',
        skill: {
            name: 'Vigorous',
            description:
        'When HP is above 90%, increases CRIT Rate by <span style="color: #99FFFFFF;">14%/17.5%/21%/24.5%/28%</span>.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    travelers_handy_sword: {
      ...
      'A handy steel sword which contains scissors, a magnifying glass, tinder, and other useful items in its sheath.',
        skill: {
            name: 'Journey',
            description:
        'Each Elemental Orb or Particle collected restores <span style="color: #99FFFFFF;">1%/1.25%/1.5%/1.75%/2%</span> HP.',
        },
        secondary: {
            name: 'defPercent',
            stats: [
    ...
    dark_iron_sword: {
      ...
      'A perfectly ordinary iron sword, just slightly darker than most.',
        skill: {
            name: 'Overloaded',
            description:
        'Upon causing an Overloaded, Superconduct, Electro-Charged, or an Electro-infused Swirl reaction, ATK is increased by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 12s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    fillet_blade: {
      ...
      'A sharp filleting knife. The blade is long, thin, and incredibly sharp.',
        skill: {
            name: 'Gash',
            description:
        'On hit, has a 50% chance to deal <span style="color: #99FFFFFF;">240%/280%/320%/360%/400%</span> ATK DMG to a single opponent. Can only occur once every <span style="color: #99FFFFFF;">15/14/13/12/11</span>s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    skyrider_sword: {
      ...
      'A reliable steel sword. The legendary Skyrider once tried to ride it as a flying sword...',
        skill: {
            name: 'Determination',
            description:
        'Using an Elemental Burst grants a <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span> increase in ATK and Movement SPD for 15s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    favonius_sword: {
      ...
      "A standard-issue longsword of the Knights of Favonius. When you're armed with this agile and sharp weapon, channeling the power of the elements has never been so easy!",
        skill: {
            name: 'Windfall',
            description:
        'CRIT Hits have a <span style="color: #99FFFFFF;">60%/70%/80%/90%/100%</span> chance to generate a small amount of Elemental Particles, which will regenerate 6 Energy for the character. Can only occur once every <span style="color: #99FFFFFF;">12/10.5/9/7.5/6</span>s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    the_flute: {
      ...
      'Beneath its rusty exterior is a lavishly decorated thin blade. It swings as swiftly as the wind.',
        skill: {
            name: 'Chord',
            description:
        'Normal or Charged Attacks grant a Harmonic on hits. Gaining 5 Harmonics triggers the power of music and deals <span style="color: #99FFFFFF;">100%/125%/150%/175%/200%</span> ATK DMG to surrounding opponents. Harmonics last up to 30s, and a maximum of 1 can be gained every 0.5s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    sacrificial_sword: {
      ...
      'A ceremonial sword that has become petrified over time. The trinkets on it are still visible. It grants the wielder the power to withstand the winds of time.',
        skill: {
            name: 'Composed',
            description:
        'After damaging an opponent with an Elemental Skill, the skill has a <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> chance to end its own CD. Can only occur once every <span style="color: #99FFFFFF;">30/26/22s/19/16s</span>s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    royal_longsword: {
      ...
      'An old longsword that belonged to the erstwhile rulers of Mondstadt. Exquisitely crafted, the carvings and embellishments testify to the stature of its owner.',
        skill: {
            name: 'Focus',
            description:
        'Upon damaging an opponent, increases CRIT Rate by <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span>. Max 5 stacks. A CRIT Hit removes all stacks.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    lions_roar: {
      ...
      'A sharp blade with extravagant carvings that somehow does not compromise on durability and sharpness. It roars like a lion as it cuts through the air.',
        skill: {
            ...
            description:
        'Increases DMG against opponents affected by Pyro or Electro by <span style="color: #99FFFFFF;">20%/24%/28%/32%/36%</span>.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    prototype_rancour: {
      ...
      'An ancient longsword discovered in the Blackcliff Forge that cuts through rocks like a hot knife through butter.',
        skill: {
            name: 'Smashed Stone',
            description:
        'On hit, Normal or Charged Attacks increase ATK and DEF by <span style="color: #99FFFFFF;">4%/5%/6%/7%/8%</span> for 6s. Max 4 stacks. This effect can only occur once every 0.3s.',
        },
        secondary: {
            name: 'physicalDamage',
            stats: [
    ...
    iron_sting: {
      ...
      'An exotic long-bladed rapier that somehow found its way into Liyue via foreign traders. It is light, agile, and sharp.',
        skill: {
            ...
            description:
        'Dealing Elemental DMG increases all DMG by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span> for 6s. Max 2 stacks. Can occur once every 1s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    blackcliff_longsword: {
      ...
      'A sword made of a material known as "blackcliff." It has a dark crimson glow on its black blade.',
        skill: {
            ...
            description:
        'After defeating an opponent, ATK is increased by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span> for 30s. This effect has a maximum of 3 stacks, and the duration of each stack is independent of the others.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    the_black_sword: {
      ...
      'A pitch-black longsword that thirsts for violence and conflict. It is said that this weapon can cause its user to become drunk on the red wine of slaughter.',
        skill: {
            name: 'Justice',
            description:
        'Increases DMG dealt by Normal and Charged Attacks by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. Additionally, regenerates <span style="color: #99FFFFFF;">60%/70%/80%/90%/100%</span> of ATK as HP when Normal and Charged Attacks score a CRIT Hit. This effect can occur once every 5s.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    the_alley_flash: {
      ...
      'A straight sword as black as the night. It once belonged to a thief who roamed the benighted streets.',
        skill: {
            name: 'Itinerant Hero',
            description:
        'Increases DMG dealt by the character equipping this weapon by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. Taking DMG disables this effect for 5s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    festering_desire: {
      ...
      'A creepy straight sword that almost seems to yearn for life. It drips with a shriveling venom that could even corrupt a mighty dragon.',
        skill: {
            ...
            description:
        'Increases Elemental Skill DMG by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> and Elemental Skill CRIT Rate by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span>.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    cinnabar_spindle: {
      ...
      'A sword made from materials that do not belong in this world. The power within might even be able to withstand the corruption of a venom that could corrode a mighty dragon.',
        skill: {
            name: 'Spotless Heart',
            description:
        'Elemental Skill DMG is increased by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> of DEF. The effect will be triggered no more than once every 1.5s and will be cleared 0.1s after the Elemental Skill deals DMG.',
        },
        secondary: {
            name: 'defPercent',
            stats: [
    ...
    skyward_blade: {
      ...
      'The sword of a knight that symbolizes the restored honor of Dvalin. The blessings of the Anemo Archon rest on the fuller of the blade, imbuing the sword with the powers of the sky and the wind.',
        skill: {
            ...
            description:
        'CRIT Rate increased by <span style="color: #99FFFFFF;">4%/5%/6%/7%/8%</span>. Gains Skypiercing Might upon using an Elemental Burst: Increases Movement SPD by <span style="color: #99FFFFFF;">10%/10%/10%/10%/10%</span>, increases ATK SPD by <span style="color: #99FFFFFF;">10%/10%/10%/10%/10%</span>, and Normal and Charged hits deal additional DMG equal to <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> of ATK. Skypiercing Might lasts for 12s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    summit_shaper: {
      ...
      'A symbol of a legendary pact, this sharp blade once cut off the peak of a mountain.',
        skill: {
            name: 'Golden Majesty',
            description:
        'Increases Shield Strength by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. Scoring hits on opponents increases ATK by <span style="color: #99FFFFFF;">4%/5%/6%/7%/8%</span> for 8s. Max 5 stacks. Can only occur once every 0.3s. While protected by a shield, this ATK increase effect is increased by 100%.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    primordial_jade_cutter: {
      ...
      'A ceremonial sword masterfully carved from pure jade. There almost seems to be an audible sigh in the wind as it is swung.',
        skill: {
            ...
            description:
        'HP increased by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. Additionally, provides an ATK Bonus based on <span style="color: #99FFFFFF;">1.2%/1.5%/1.8%/2.1%/2.4%</span> of the wielder\'s Max HP.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    ferrous_shadow: {
      ...
      'A replica of the famed sword of Arundolyn, the Lion of Light. Feel the power of a legendary hero as you hold this sword in your hand! Imagine yourself as the great warrior himself! Note: Daydreaming not recommended in live combat.',
        skill: {
            name: 'Unbending',
            description:
        'When HP falls below <span style="color: #99FFFFFF;">70%/75%/80%/85%/90%</span>, increases Charged Attack DMG by <span style="color: #99FFFFFF;">30%/35%/40%/45%/50%</span> and Charged Attacks become harder to interrupt.',
        },
        secondary: {
            name: 'hpPercent',
            stats: [
    ...
    bloodtainted_greatsword: {
      ...
      'A steel sword that is said to have been coated with dragon blood, rendering it invulnerable to damage. This effect is not extended to its wielder, however.',
        skill: {
            name: 'Bane of Fire and Thunder',
            description:
        'Increases DMG dealt against opponents affected by Pyro or Electro by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    white_iron_greatsword: {
      ...
      'A claymore made from white iron. Lightweight without compromising on power. Effective even when wielded by one of average strength, it is extremely deadly in the hands of a physically stronger wielder.',
        skill: {
            name: 'Cull the Weak',
            description:
        'Defeating an opponent restores <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> HP.',
        },
        secondary: {
            name: 'defPercent',
            stats: [
    ...
    quartz: {
      ...
      'A simple but heavy greatsword made of polished black quartz with a golden gilt. It has an air of elegance and dignity about it.',
        skill: {
            name: 'Residual Heat',
            description:
        'Upon causing an Overloaded, Melt, Burning, Vaporize, or a Pyro-infused Swirl reaction, ATK is increased by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 12s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    debate_club: {
      ...
      "A handy club made of fine steel. The most persuasive line of reasoning in any debater's arsenal.",
        skill: {
            ...
            description:
        'After using an Elemental Skill, on hit, Normal and Charged Attacks deal additional DMG equal to <span style="color: #99FFFFFF;">60%/75%/90%/105%/120%</span> of ATK in a small AoE. Effect lasts 15s. DMG can only occur once every 3s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    skyrider_greatsword: {
      ...
      'A reliable steel sword. The legendary Skyrider once tried to ride it as a flying sword... for the second time.',
        skill: {
            name: 'Courage',
            description:
        'On hit, Normal or Charged Attacks increase ATK by <span style="color: #99FFFFFF;">6%/7%/8%/9%/10%</span> for 6s. Max 4 stacks. Can occur once every 0.5s.',
        },
        secondary: {
            name: 'physicalDamage',
            stats: [
    ...
    rainslasher: {
      ...
      'A fluorescent greatsword with no sharp edge that crushes enemies with brute force and raw power.',
        skill: {
            ...
            description:
        'Increases DMG against opponents affected by Hydro or Electro by <span style="color: #99FFFFFF;">20%/24%/28%/32%/36%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    prototype_archaic: {
      ...
      'An ancient greatsword discovered in the Blackcliff Forge. It swings with such an immense force that one feels it could cut straight through reality itself.',
        skill: {
            name: 'Crush',
            description:
        'On hit, Normal or Charged Attacks have a 50% chance to deal an additional <span style="color: #99FFFFFF;">240%/300%/360%/420%/480%</span> ATK DMG to opponents within a small AoE. Can only occur once every 15s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    whiteblind: {
      ...
      'An exotic sword with one section of the blade left blunt. It made its way into Liyue via the hands of foreign traders. Incredibly powerful in the hands of someone who knows how to use it.',
        skill: {
            name: 'Infusion Blade',
            description:
        'On hit, Normal or Charged Attacks increase ATK and DEF by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span> for 6s. Max 4 stacks. This effect can only occur once every 0.5s.',
        },
        secondary: {
            name: 'defPercent',
            stats: [
    ...
    lithic_blade: {
      ...
      'A greatsword carved and chiseled from the very bedrock of Liyue.',
        skill: {
            ...
            description:
        'For every character in the party who hails from Liyue, the character who equips this weapon gains a <span style="color: #99FFFFFF;">7%/8%/9%/10%/11%</span> ATK increase and a <span style="color: #99FFFFFF;">3%/4%/5%/6%/7%</span> CRIT Rate increase. This effect stacks up to 4 times.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    'luxurious_sea-lord': {
      ...
      'The great king of the ocean. Having been air-dried, it makes for a fine weapon as well as emergency sustenance.',
        skill: {
            ...
            description:
        'Increases Elemental Burst DMG by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. When Elemental Burst hits opponents, there is a 100% chance of summoning a huge onrush of tuna that deals <span style="color: #99FFFFFF;">100%/125%/150%/175%/200%</span> ATK as AoE DMG. This effect can occur once every 15s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    katsuragikiri_nagamasa: {
        ...
        skill: {
            ...
            description:
        'Increases Elemental Skill DMG by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span>. After Elemental Skill hits an opponent, the character loses 3 Energy but regenerates <span style="color: #99FFFFFF;">3/3.5/4/4.5/5</span> Energy every 2s for the next 6s. This effect can occur once every 10s. Can be triggered even when the character is not on the field.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    akuoumaru: {
      ...
      'The beloved sword of the legendary "Akuou." The blade is huge and majestic, but is surprisingly easy to wield.',
        skill: {
            ...
            description:
        'For every point of the entire party\'s combined maximum Energy capacity, the Elemental Burst DMG of the character equipping this weapon is increased by <span style="color: #99FFFFFF;">0.12%/0.15%/0.18%/0.21%/0.24%</span>. A maximum of <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> increased Elemental Burst DMG can be achieved this way.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    skyward_pride: {
      ...
      "A claymore that symbolizes the pride of Dvalin soaring through the skies. When swung, it emits a deep hum as the full force of Dvalin's command of the sky and the wind is unleashed.",
        skill: {
            ...
            description:
        'Increases all DMG by <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span>. After using an Elemental Burst, Normal or Charged Attack, on hit, creates a vacuum blade that does <span style="color: #99FFFFFF;">80%/100%/120%/140%/160%</span> of ATK as DMG to opponents along its path. Lasts for 20s or 8 vacuum blades.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    wolfs_gravestone: {
      ...
      'A longsword used by the Wolf Knight. Originally just a heavy sheet of iron given to the knight by a blacksmith from the city, it became endowed with legendary power owing to his friendship with the wolves.',
        skill: {
            ...
            description:
        'Increases ATK by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. On hit, attacks against opponents with less than 30% HP increase all party members\' ATK by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> for 12s. Can only occur once every 30s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    redhorn_stonethresher: {
      ...
      'According to its previous owner, this weapon is the "Mighty Redhorn Stoic Stonethreshing Gilded Goldcrushing Lion Lord" that can send any monster packing with its tail between its legs.',
        skill: {
            ...
            description:
        'DEF is increased by <span style="color: #99FFFFFF;">28%/35%/42%/49%/56%</span>. Normal and Charged Attack DMG is increased by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> of DEF.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    white_tassel: {
      ...
      "A standard-issue weapon of the Millelith soldiers. It has a sturdy shaft and sharp spearhead. It's a reliable weapon.",
        skill: {
            name: 'Sharp',
            description:
        'Increases Normal Attack DMG by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span>.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    black_tassel: {
      ...
      'An exceptionally powerful polearm that also offers a simple but elegant solution to the issue of the easily stained white tassel.',
        skill: {
            ...
            description:
        'Increases DMG against slimes by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span>.',
        },
        secondary: {
            name: 'hpPercent',
            stats: [
    ...
    dragons_bane: {
      ...
      'A polearm decorated with an entwining golden dragon. Light and sharp, this weapon may very well kill dragons with ease.',
        skill: {
            ...
            description:
        'Increases DMG against opponents affected by Hydro or Pyro by <span style="color: #99FFFFFF;">20%/24%/28%/32%/36%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    prototype_starglitter: {
      ...
      'A hooked spear discovered hidden away in the Blackcliff Forge. The glimmers along the sharp edge are like stars in the night.',
        skill: {
            name: 'Magic Affinity',
            description:
        'After using an Elemental Skill, increases Normal and Charged Attack DMG by <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> for 12s. Max 2 stacks.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    crescent_pike: {
      ...
      'An exotic weapon with an extremely long blade on the top and a crescent blade at the bottom. It found its way into Liyue through foreign traders. With practice, it can deal heavy damage.',
        skill: {
            ...
            description:
        'After picking up an Elemental Orb/Particle, Normal and Charged Attacks deal additional DMG equal to <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> of ATK for 5s.',
        },
        secondary: {
            name: 'physicalDamage',
            stats: [
    ...
    blackcliff_pole: {
      ...
      'A weapon made of blackcliff and aerosiderite. There is a dark crimson glow on its cold black sheen.',
        skill: {
            name: 'Press the Advantage',
            description:
        'After defeating an enemy, ATK is increased by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span> for 30s. This effect has a maximum of 3 stacks, and the duration of each stack is independent of the others.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    deathmatch: {
      ...
      "A sharp crimson polearm that was once a gladiator's priceless treasure. Its awl has been stained by the blood of countless beasts and men.",
        skill: {
            name: 'Gladiator',
            description:
        'If there are at least 2 opponents nearby, ATK is increased by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> and DEF is increased by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span>. If there are fewer than 2 opponents nearby, ATK is increased by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span>.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    the_catch: {
      ...
      'In the distant past, this was the beloved spear of a famed Inazuman bandit.',
        skill: {
            name: 'Shanty',
            description:
        'Increases Elemental Burst DMG by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> and Elemental Burst CRIT Rate by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span>.',
        },
        secondary: {
            name: 'er',
            stats: [
      ...
      'A naginata forged from luminescent material deep in the ocean depths. It was once the possession of the tengu race.',
        ...
        secondary: {
            ...
            stats: [
                ...
                0.03485999744698409,
                0.03485999744698409,
                0.040890000144615746,
                0.040890000144615746,
                0.040890000144615746,
                0.040890000144615746,
                0.040890000144615746,
                0.046950000667199454,
                0.046950000667199454,
                0.046950000667199454,
                0.046950000667199454,
                0.046950000667199454,
                0.053009997613504556,
                0.053009997613504556,
                0.053009997613504556,
                0.053009997613504556,
                0.053009997613504556,
                0.053009997613504556,
                0.059069998136088264,
                0.059069998136088264,
                0.059069998136088264,
                0.059069998136088264,
                0.059069998136088264,
    ...
    staff_of_homa: {
      ...
      'A "firewood staff" that was once used in ancient and long-lost rituals.',
        skill: {
            ...
            description:
        'HP increased by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. Additionally, provides an ATK Bonus based on <span style="color: #99FFFFFF;">0.8%/1%/1.2%/1.4%/1.6%</span> of the wielder\'s Max HP. When the wielder\'s HP is less than 50%, this ATK Bonus is increased by an additional <span style="color: #99FFFFFF;">1%/1.2%/1.4%/1.6%/1.8%</span> of Max HP.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    skyward_spine: {
      ...
      "A polearm that symbolizes Dvalin's firm resolve. The upright shaft of this weapon points towards the heavens, clad in the might of sky and wind.",
        skill: {
            name: 'Black Wing',
            description:
        'Increases CRIT Rate by <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> and increases Normal ATK SPD by <span style="color: #99FFFFFF;">12%/12%/12%/12%/12%</span>. Additionally, Normal and Charged Attacks hits on opponents have a <span style="color: #99FFFFFF;">50%/50%/50%/50%/50%</span> chance to trigger a vacuum blade that deals <span style="color: #99FFFFFF;">40%/55%/70%/85%/100%</span> of ATK as DMG in a small AoE. This effect can occur no more than once every 2s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    'primordial_jade_winged-spear': {
      ...
      'A jade polearm made by the archons, capable of slaying ancient beasts.',
        skill: {
            ...
            description:
        'On hit, increases ATK by <span style="color: #99FFFFFF;">3.2%/3.9%/4.6%/5.3%/6%</span> for 6s. Max 7 stacks. This effect can only occur once every 0.3s. While in possession of the maximum possible stacks, DMG dealt is increased by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    calamity_queller: {
      ...
      'A keenly honed weapon forged from some strange crystal. Its faint blue light seems to whisper of countless matters now past.',
        skill: {
            ...
            description:
        'Gain <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span> All Elemental DMG Bonus. Obtain Consummation for 20s after using an Elemental Skill, causing ATK to increase by <span style="color: #99FFFFFF;">3.2%/4%/4.8%/5.6%/6.4%</span> per second. This ATK increase has a maximum of 6 stacks. When the character equipped with this weapon is not on the field, Consummation\'s ATK increase is doubled.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    engulfing_lightning: {
      ...
      'A naginata used to "cut grass." Any army that stands before this weapon will probably be likewise cut down...',
        skill: {
            ...
            description:
        'ATK increased by <span style="color: #99FFFFFF;">28%/35%/42%/49%/56%</span> of Energy Recharge over the base 100%. You can gain a maximum bonus of <span style="color: #99FFFFFF;">80%/90%/100%/110%/120%</span> ATK. Gain <span style="color: #99FFFFFF;">30%/35%/40%/45%/50%</span> Energy Recharge for 12s after using an Elemental Burst.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    magic_guide: {
      ...
      'Version 12. A reprint featuring corrections to Version 11 and brand-new additions based on recent developments.',
        skill: {
            name: 'Bane of Storm and Tide',
            description:
        'Increases DMG against opponents affected by Hydro or Electro by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    thrilling_tales_of_dragon_slayers: {
      ...
      'A fictional story of a band of five heroes who go off on a dragon hunt. It is poorly written and structurally incoherent. Its value lies in the many lessons that can be learned from failure.',
        skill: {
            name: 'Heritage',
            description:
        'When switching characters, the new character taking the field has their ATK increased by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span> for 10s. This effect can only occur once every 20s.',
        },
        secondary: {
            name: 'hpPercent',
            stats: [
    ...
    otherworldly_story: {
      ...
      'A cheap fantasy novel with no value whatsoever. Any claim that it possesses the power of catalysis is also pure fantasy.',
        skill: {
            name: 'Energy Shower',
            description:
        'Picking up an Elemental Energy Orb/Particle recovers <span style="color: #99FFFFFF;">1%/1.25%/1.5%/1.75%/2%</span> HP.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    emerald_orb: {
      ...
      'A catalyst carved out of the hard jade from Jueyun Karst north of Liyue. Small, light, and durable, it is known more colloquially as the "jade ball."',
        skill: {
            name: 'Rapids',
            description:
        'Upon causing a Vaporize, Electro-Charged, Frozen, or a Hydro-infused Swirl reaction, increases ATK by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 12s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    twin_nephrite: {
        ...
        skill: {
            ...
            description:
        'Defeating an opponent increases Movement SPD and ATK by <span style="color: #99FFFFFF;">12%/14%/16%/18%/20%</span> for 15s.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    amber_bead: {
      ...
      'A catalyst carved out of amber that gains a warm halo under the sun.',
        skill: {
            ...
            description:
        'Normal Attack hits increase all Elemental DMG by <span style="color: #99FFFFFF;">6%/7.5%/9%/10.5%/12%</span> for 6s. Max 2 stacks.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    solar_pearl: {
      ...
      'A dull, golden pearl made of an unknown substance that harbors the light of the sun and the moon and pulses with a warm strength.',
        skill: {
            name: 'Solar Shine',
            description:
        'Normal Attack hits increase Elemental Skill and Elemental Burst DMG by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 6s. Likewise, Elemental Skill or Elemental Burst hits increase Normal Attack DMG by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 6s.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    prototype_amber: {
      ...
      'A dully gilded catalyst secretly guarded in the Blackcliff Forge. It seems to glow with the very light from the sky.',
        skill: {
            name: 'Gilding',
            description:
        'Using an Elemental Burst regenerates <span style="color: #99FFFFFF;">4/4.5/5/5.5/6</span> Energy every 2s for 6s. All party members will regenerate <span style="color: #99FFFFFF;">4%/4.5%/5%/5.5%/6%</span> HP every 2s for this duration.',
        },
        secondary: {
            name: 'hpPercent',
            stats: [
    ...
    mappa_mare: {
      ...
      'A nautical chart featuring nearby currents and climates that somehow found its way into Liyue via foreign traders.',
        skill: {
            ...
            description:
        'Triggering an Elemental reaction grants a <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> Elemental DMG Bonus for 10s. Max 2 stacks.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    eye_of_perception: {
      ...
      "A dim black glaze pearl that is said to have the power to read the purity of one's heart.",
        skill: {
            name: 'Echo',
            description:
        'Normal and Charged Attacks have a 50% chance to fire a Bolt of Perception, dealing <span style="color: #99FFFFFF;">240%/270%/300%/330%/360%</span> ATK as DMG. This bolt can bounce between opponents a maximum of 4 times. This effect can occur once every <span style="color: #99FFFFFF;">12/11/10/9/8</span>s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    wine_and_song: {
      ...
      'A songbook from the bygone aristocratic era, whose composer has become forgotten. It chronicles the tale of a certain heroic outlaw.',
        skill: {
            name: 'Ever-Changing',
            description:
        'Hitting an opponent with a Normal Attack decreases the Stamina consumption of Sprint or Alternate Sprint by <span style="color: #99FFFFFF;">14%/16%/18%/20%/22%</span> for 5s. Additionally, using a Sprint or Alternate Sprint ability increases ATK by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 5s.',
        },
        secondary: {
            name: 'er',
            stats: [
    ...
    dodoco_tales: {
      ...
      "A children's book filled with childish short stories at which one cannot help but laugh.\\nEven those readers who have long reached adulthood cannot help but be absorbed by the innocent, naive little adventures portrayed within.",
        skill: {
            name: 'Dodoventure!',
            description:
        'Normal Attack hits on opponents increase Charged Attack DMG by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> for 6s. Charged Attack hits on opponents increase ATK by <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> for 6s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    oathsworn_eye: {
      ...
      'A national treasure of Byakuyakoku stored in the Dainichi Mikoshi. With the coming of the Serpent God, this item was used to notarize great oaths and wishes.',
        skill: {
            ...
            description:
        'Increases Energy Recharge by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span> for 10s after using an Elemental Skill.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    skyward_atlas: {
      ...
      'A cloud atlas symbolizing Dvalin and his former master, the Anemo Archon. It details the winds and clouds of the northern regions and contains the powers of the sky and wind.',
        skill: {
            ...
            description:
        'Increases Elemental DMG Bonus by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. Normal Attack hits have a 50% chance to earn the favor of the clouds, which actively seek out nearby opponents to attack for 15s, dealing <span style="color: #99FFFFFF;">160%/200%/240%/280%/320%</span> ATK DMG. Can only occur once every 30s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    lost_prayer_to_the_sacred_winds: {
      ...
      'An educational tome written by anonymous early inhabitants who worshiped the wind. It has been blessed by the wind for its faithfulness and influence over the millennia.',
        skill: {
            ...
            description:
        'Increases Movement SPD by 10%. When in battle, gain an <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> Elemental DMG Bonus every 4s. Max 4 stacks. Lasts until the character falls or leaves combat.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    everlasting_moonglow: {
      ...
      'A string of lovely jasper from the deep sea. It shines with a pure radiance like that of the moon, and just as ever-distant.',
        skill: {
            ...
            description:
        'Healing Bonus increased by <span style="color: #99FFFFFF;">10%/12.5%/15%/17.5%/20%</span>, Normal Attack DMG is increased by <span style="color: #99FFFFFF;">1%/1.5%/2%/2.5%/3%</span> of the Max HP of the character equipping this weapon. For 12s after using an Elemental Burst, Normal Attacks that hit opponents will restore 0.6 Energy. Energy can be restored this way once every 0.1s.',
        },
        secondary: {
            name: 'hpPercent',
            stats: [
    ...
    raven_bow: {
      ...
      "Ravens are known to be the ferrymen of the dead. This bow's limb is decorated with raven feathers, which forebode the imminent death of its target.",
        skill: {
            name: 'Bane of Flame and Water',
            description:
        'Increases DMG against opponents affected by Hydro or Pyro by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    sharpshooters_oath: {
      ...
      'This superior bow once belonged to a master archer. However, it gives off a strong scent, thus making it unsuitable for hunting.',
        skill: {
            name: 'Precise',
            description:
        'Increases DMG against weak spots by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span>.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    slingshot: {
      ...
      'A bow, despite the name. After countless experiments and improvements to the design, the creator of the ultimate slingshot found himself to have made what was actually a bow.',
        skill: {
            name: 'Slingshot',
            description:
        'If a Normal or Charged Attack hits a target within 0.3s of being fired, increases DMG by <span style="color: #99FFFFFF;">36%/42%/48%/54%/60%</span>. Otherwise, decreases DMG by 10%.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    messenger: {
      ...
      'A basic wooden bow. It is said to have once been used as a tool for long-distance communication.',
        skill: {
            ...
            description:
        'Charged Attack hits on weak points deal an additional <span style="color: #99FFFFFF;">100%/125%/150%/175%/200%</span> ATK DMG as CRIT DMG. Can only occur once every 10s.',
        },
        secondary: {
            name: 'critDamage',
            stats: [
    ...
    ebony_bow: {
      ...
      'A longbow made of ebony wood with stiffer limbs than ordinary bows. It is also a far more powerful weapon.',
        skill: {
            name: 'Decimate',
            description:
        'Increases DMG against mechanoid Ruin opponents by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span>.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    the_stringless: {
      ...
      'A bow that once served as an extraordinary instrument. It is no longer capable of getting people up and dancing.',
        skill: {
            name: 'Arrowless Song',
            description:
        'Increases Elemental Skill and Elemental Burst DMG by <span style="color: #99FFFFFF;">24%/30%/36%/42%/48%</span>.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    rust: {
      ...
      'A completely rusted iron greatbow. The average person would lack the strength to even lift it, let alone fire it.',
        skill: {
            name: 'Rapid Firing',
            description:
        'Increases Normal Attack DMG by <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> but decreases Charged Attack DMG by 10%.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    prototype_crescent: {
      ...
      'A prototype longbow discovered in the Blackcliff Forge. The arrow fired from this bow glimmers like a ray of moonlight.',
        skill: {
            name: 'Unreturning',
            description:
        'Charged Attack hits on weak points increase Movement SPD by 10% and ATK by <span style="color: #99FFFFFF;">36%/45%/54%/63%/72%</span> for 10s.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    compound_bow: {
      ...
      'An exotic metallic bow from a distant land. Though extremely difficult to maintain, it is easy to nock and fires with tremendous force.',
        skill: {
            name: 'Infusion Arrow',
            description:
        'Normal Attack and Charged Attack hits increase ATK by <span style="color: #99FFFFFF;">4%/5%/6%/7%/8%</span> and Normal ATK SPD by <span style="color: #99FFFFFF;">1.2%/1.5%/1.8%/2.1%/2.4%</span> for 6s. Max 4 stacks. Can only occur once every 0.3s.',
        },
        secondary: {
            name: 'physicalDamage',
            stats: [
    ...
    the_viridescent_hunt: {
      ...
      'A pure green hunting bow. This once belonged to a certain hunter whose home was the forest.',
        skill: {
            name: 'Verdant Wind',
            description:
        'Upon hit, Normal and Aimed Shot Attacks have a 50% chance to generate a Cyclone, which will continuously attract surrounding opponents, dealing <span style="color: #99FFFFFF;">40%/50%/60%/70%/80%</span> of ATK as DMG to these opponents every 0.5s for 4s. This effect can only occur once every <span style="color: #99FFFFFF;">14/13/12/11/10</span>s.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    alley_hunter: {
      ...
      'An intricate, opulent longbow. It once belonged to a gentleman thief who was never caught.',
        skill: {
            name: 'Oppidan Ambush',
            description:
        'While the character equipped with this weapon is in the party but not on the field, their DMG increases by <span style="color: #99FFFFFF;">2%/2.5%/3%/3.5%/4%</span> every second up to a max of <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. When the character is on the field for more than 4s, the aforementioned DMG buff decreases by <span style="color: #99FFFFFF;">4%/5%/6%/7%/8%</span> per second until it reaches 0%.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    mitternachts_waltz: {
      ...
      'A bow painted the color of transgression and nights of illusion.',
        skill: {
            name: 'Evernight Duet',
            description:
        'Normal Attack hits on opponents increase Elemental Skill DMG by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 5s. Elemental Skill hits on opponents increase Normal Attack DMG by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span> for 5s.',
        },
        secondary: {
            name: 'physicalDamage',
            stats: [
    ...
    windblume_ode: {
      ...
      'A bow adorned with nameless flowers that bears the earnest hopes of an equally nameless person.',
        skill: {
            name: 'Windblume Wish',
            description:
        'After using an Elemental Skill, receive a boon from the ancient wish of the Windblume, increasing ATK by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> for 6s.',
        },
        secondary: {
            name: 'em',
            stats: [
    ...
    hamayumi: {
      ...
      'A certain shrine maiden once owned this warbow. It was made with surpassing skill, and is both intricate and sturdy.',
        skill: {
            name: 'Full Draw',
            description:
        'Increases Normal Attack DMG by <span style="color: #99FFFFFF;">16%/20%/24%/28%/32%</span> and Charged Attack DMG by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. When the equipping character\'s Energy reaches 100%, this effect is increased by 100%.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    skyward_harp: {
      ...
      "A greatbow that symbolizes Dvalin's affiliation with the Anemo Archon. The sound of the bow firing is music to the Anemo Archon's ears. It contains the power of the sky and wind within.",
        skill: {
            name: 'Echoing Ballad',
            description:
        'Increases CRIT DMG by <span style="color: #99FFFFFF;">20%/25%/30%/35%/40%</span>. Hits have a <span style="color: #99FFFFFF;">60%/70%/80%/90%/100%</span> chance to inflict a small AoE attack, dealing 125% Physical ATK DMG. Can only occur once every <span style="color: #99FFFFFF;">4/3.5/3/2.5/2</span>s.',
        },
        secondary: {
            name: 'critRate',
            stats: [
    ...
    amos_bow: {
      ...
      'An extremely ancient bow that has retained its power despite its original master being long gone. It draws power from everyone and everything in the world, and the further away you are from that which your heart desires, the more powerful it is.',
        skill: {
            name: 'Strong-Willed',
            description:
        'Increases Normal and Charged Attack DMG by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. After a Normal or Charged Attack is fired, DMG dealt increases by a further <span style="color: #99FFFFFF;">8%/10%/12%/14%/16%</span> every 0.1s the arrow is in the air for up to 5 times.',
        },
        secondary: {
            name: 'atkPercent',
            stats: [
    ...
    polar_star: {
      ...
      'A pristine bow that is as sharp as the glaciers of the far north.',
        skill: {
            ...
            description:
        'Elemental Skill and Elemental Burst DMG increased by <span style="color: #99FFFFFF;">12%/15%/18%/21%/24%</span>. After a Normal Attack, Charged Attack, Elemental Skill or Elemental Burst hits an opponent, 1 stack of Ashen Nightstar will be gained for 12s. When 1/2/3/4 stacks of Ashen Nightstar are present, ATK is increased by <span style="color: #99FFFFFF;">10/20/30/48%/12.5/25/37.5/60%/15/30/45/72%/17.5/35/52.5/84%/20/40/60/96%</span>. The stack of Ashen Nightstar created by the Normal Attack, Charged Attack, Elemental Skill or Elemental Burst will be counted independently of the others.',
        },
        secondary: {
            name: 'critRate',
            stats: [
